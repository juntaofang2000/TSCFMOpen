        ...
        if tree_model == "decision_tree":
            ...
            if XGBRegressor is None:
                raise ModuleNotFoundError(
                    "xgboost is not installed, but tree_model='xgboost' was requested. "
                    "Install xgboost or use tree_model in {decision_tree, extra_trees, random_forest}."
                )
    ...
    **kwargs : dict
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Optional dependency: fall back to a sklearn model if xgboost isn't installed.
        if tree_model == "xgboost" and XGBRegressor is None:
